...
def architecture_upconv_c5_mp6(input_var, input_shape):
    ...
    net['uc2'] = batch_norm(TransposedConv2DLayer(net['c1'], num_filters= 16, filter_size= 4, stride = 2, crop=1, **kwargs))
    print(net['uc2'].output_shape)
    net['c2'] = batch_norm(Conv2DLayer(net['uc2'], num_filters= 16, filter_size= 3, stride = 1, pad=1, **kwargs))
    print(net['c2'].output_shape) 
    
    net['uc3'] = batch_norm(TransposedConv2DLayer(net['c2'], num_filters= 8, filter_size= 4, stride = 2, crop=1, **kwargs))
    print(net['uc3'].output_shape)
