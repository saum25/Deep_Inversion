...
def architecture_upconv(input_var, input_shape):
    ...
    net['fc2'] = batch_norm(DenseLayer(net['data'], num_units=256, W=lasagne.init.HeUniform(gain=1.35), nonlinearity=lasagne.nonlinearities.elu))
    ...
    kwargs = dict(filter_size= 4,
                  ...
                  W=lasagne.init.HeUniform(gain=1.35))
